...
public class ModArmorItemLeggingsLVLTWO extends ArmorItem {
    ...
    public ModArmorItemLeggingsLVLTWO(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
