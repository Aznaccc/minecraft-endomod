...
public class ModArmorItemBoots extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffect>())
                    ...
                    .put(InvisArmorMaterial.INVIS, StatusEffects.INVISIBILITY)
                    .put(JumpBoostArmorMaterial.JUMP, StatusEffects.JUMP_BOOST)
                    .put(SpeedArmorMaterial.SPEED, StatusEffects.SPEED).build();



    public ModArmorItemBoots(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
