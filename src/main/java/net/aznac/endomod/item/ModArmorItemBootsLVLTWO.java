...
public class ModArmorItemBootsLVLTWO extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffect>())
                    .put(JumpBoostTwoArmorMaterial.JUMPTWO, StatusEffects.JUMP_BOOST)
                    .put(SpeedTwoArmorMaterial.SPEEDTWO, StatusEffects.SPEED).build();



    public ModArmorItemBootsLVLTWO(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
