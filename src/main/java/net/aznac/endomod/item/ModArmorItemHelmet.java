...
public class ModArmorItemHelmet extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffect>())
                    .put(WaterBreathingArmorMaterial.WATERBREATHING, StatusEffects.WATER_BREATHING)
                    .put(NightVisionArmorMaterial.NIGHTVISION, StatusEffects.NIGHT_VISION).build();



    public ModArmorItemHelmet(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
